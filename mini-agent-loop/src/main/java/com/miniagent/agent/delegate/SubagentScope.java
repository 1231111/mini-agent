...
public final class SubagentScope implements AutoCloseable {
    ...
    private final MemoryStore.OwnerContext parentOwner;
    ...
    private SubagentScope(String parentSession, String parentRole, PermissionMode parentMode,
                          ...
                          MemoryStore.OwnerContext parentOwner, Path parentWorkspaceRoot,
                          String parentTaskOverride) {
    ...
    public static SubagentScope enter(String subSessionId, String roleId, boolean inheritAsk) {
        ...
        MemoryStore.OwnerContext parentOwner = MemoryStore.captureOwnerContext();
        ...
        SubagentScope scope = new SubagentScope(
                ...
                parentChat, parentStreaming, parentOwner, parentWs, parentTask);
    ...
    private static void restoreOwner(MemoryStore.OwnerContext owner) {
        Optional.ofNullable(owner.userId())
                .ifPresentOrElse(MemoryStore::setCurrentUser, MemoryStore::clearCurrentUser);
        Optional.ofNullable(owner.tenantId())
                .filter(StringUtils::isNotBlank)
                .ifPresentOrElse(MemoryStore::setCurrentTenant, MemoryStore::clearCurrentTenant);
    }
}
